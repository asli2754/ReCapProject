...
namespace DataAccess.Concrete.IEntityFramework
{
    ...
    {                               // 3.1.11 sürümünü yükleyin 
        ...
        {
            optionsBuilder.UseSqlServer(@"Server = (localdb)\mssqllocaldb;Database = Northwind;Trusted_Connection = true");// Hangi veritabanı ile ilişkili olduğunu belirttiğimiz yer.
